...
/** Base class for generated Neoforms. The initialization stuff is handled here.
 * @param M the model class
 * @param C the platform dependent Composite class
 */
public abstract class AbstractNeoform<M, C> implements ModelHolder<M>
{
    private M model;
     ...
     */
    public abstract void createContents(final C parent);
