...
public class NeoformContext
{
    ...
    private ImageRegistryUtil imageRegistryUtil;
    ...
    /**
     * @return the ImageRegistryUtil for icon creation/usage.
     */
    public ImageRegistryUtil getImageRegistryUtil()
    {
        return imageRegistryUtil;
    }

    public void setImageRegistryUtil(ImageRegistryUtil imageRegistryUtil)
    {
        this.imageRegistryUtil = imageRegistryUtil;
    }
