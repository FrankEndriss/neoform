 ...
 */
public class NeoformTable<C extends Collection<M>, M> extends AbstractNeoformComponent<C> {
     ...
     */
    public NeoformTable(Composite parent, List<TableColDesc<M>> tableDesc) {
